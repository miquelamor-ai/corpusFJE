...
-   **Magis (El Més):** Sovint malinterpretat com a competitivitat, el *Magis* és el dinamisme de buscar sempre el "major servei" i la "major glòria de Déu" [Source: 7: Característiques de l'educació a la companyia de Jesús. 1986.pdf] . És l'excel·lència humana per sobre de la mediocritat [Source: 9: samaritans, mestres i testimonis [CATALÁ].pdf] .
-   **Non Multa Sed Multum:** "No molt, sinó molt bé". Principi que prioritza la profunditat del coneixement i l'assaboriment intern per sobre de l'acumulació superficial d'informació [Source: 10: Característiques de l'educació a la companyia de Jesús. 1986.pdf] .
-   **Les 4 C (Perfil de l'Alumne):** L'objectiu és formar persones **Conscients** (de si mateixes i del món), **Competents** (intel·lectualment i professionalment), **Compassives** (amb el cor obert al patiment) i **Compromeses** (en la transformació social) [Source: 13: 130815_Medellin_8_Congreso_Antiguos_Alumnos.pdf] .
-   **Tantum Quantum (Tant en Quant):** Principi d'indiferència ignasiana on els mitjans (inclosa la tecnologia) s'han d'utilitzar només en la mesura que ajuden a arribar al fi formatiu [Source: 17: Característiques de l'educació a la companyia de Jesús. 1986.pdf] [Source: 18: Learning by Refraction] .
...
-   **Reflexió:** És la **clau de volta**. És el procés d'extreure significat, valor i relació amb altres sabers. *Raonament:* La dada esdevé veritat quan l'alumne la processa internament.
...
**C. Exemples Concrets d'Aplicació**

-   **Primària (Nodes d'Aprenentatge - MOPI/PIN):** En lloc de classes fragmentades, es treballa per projectes que parteixen de la curiositat de l'infant. *Exemple:* Un projecte sobre l'aigua comença amb la "motivació" (context), segueix amb la "investigació" sensorial (experiència), es "pregunta" pel seu malbaratament (reflexió) i acaba amb una campanya d'estalvi a l'escola (acció).
-   **Secundària (TQE - Reptes de Ciutadania Global):** Els alumnes de 3r/4t d'ESO aborden reptes reals del món professional o social. *Exemple:* Analitzar les rutes migratòries (context/experiència), fer un diari d'empatia (reflexió) i col·laborar amb una entitat com Migra Studium (acció).
-   **Batxillerat/FP (Projecte Vital i Vocacional):** El focus és la transició a l'edat adulta. *Exemple:* A l'FP, no només s'aprenen tècniques (competència), sinó que s'avalua com la professió pot ser un servei a la societat. S'inclouen "experiències de contrast" (voluntariats) per despertar preguntes profundes: "per a qui sóc jo?"

**D. Errors Comuns dels Docents**

-   **L'Academicisme Estèril:** Confondre l'excel·lència acadèmica amb l'excel·lència humana. Prioritzar el "molt saber" per sobre del "sentir i gustar internament".
-   **L'Escola Passiva:** Mantenir l'alumne com a receptor d'informació (dictat de continguts) en lloc de facilitador de l'autoactivitat. El docent ha de treballar en segon pla com el director dels EE.
-   **L'Indoctrinament:** Imposar valors o creences en lloc de guiar un procés de discerniment lliure. La pedagogia ignasiana respecta escrupolosament la llibertat de l'estudiant.

**E. Matissos, Límits i Excepcions**

-   **No és una "tècnica màgica":** No funciona sense la *cura personalis* i el testimoniatge de l'educador.
-   **Límits del context:** En entorns de pobresa extrema o repressió política, el discerniment es veu dificultat i cal prioritzar primer les necessitats bàsiques i la justícia.
