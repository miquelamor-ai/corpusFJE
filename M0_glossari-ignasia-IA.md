...
El carisma ignasià i la seva aplicació educativa han estat modelats per figures clau i documents fonamentals al llarg de la història de la Companyia de Jesús:

*   **Sant Ignasi de Loiola (1491-1556):** Fundador de la Companyia de Jesús. La seva experiència de conversió a Pamplona (DOC 104) va donar origen als **Exercicis Espirituals** (DOC 1, 110), una guia per al discerniment i la trobada personal amb Déu. Les seves **Constitucions** (DOC 7) i la **Fórmula del Instituto** (DOC 8) estableixen la missió fundacional de la Companyia, centrada en el servei universal de l'Església i la propagació de la fe.
*   **Pedro Arrupe S.J. (Superior General 1965-1983):** Va articular la missió educativa jesuïta en la frase "Homes i Dones per als altres" (DOC 46, 53, 109, 113), emfatitzant la formació de persones compromeses amb la justícia social. El seu discurs "Nuestros Colegios: Hoy y Mañana" (DOC 109) va desafiar els centres a renovar la seva identitat i opció social.
*   **Peter-Hans Kolvenbach S.J. (Superior General 1983-2008):** Va desenvolupar el concepte de les "quatre Cs" (Competents, Conscients, Compassius, Compromisos) com a pilars de l'excel·lència humana en l'educació jesuïta (DOC 43, 53, 109, 113). També va redefinir el "Paradigma Ledesma-Kolvenbach" (utilitas, iustitia, humanitas, fides) com a finalitats últimes de l'educació universitària jesuïta (DOC 108). Va impulsar la publicació de "Característiques de l'Educació de la Companyia de Jesús" (1986) (DOC 105, 106, 111) i "Pedagogia Ignasiana: Un Plantejament Pràctic" (1993) (DOC 99, 112, 113), que van establir el **Paradigma Pedagògic Ignasià (PPI)**.
*   **Adolfo Nicolás S.J. (Superior General 2008-2016):** Va posar l'accent en la "profunditat" i la "universalitat" de l'educació jesuïta (DOC 33, 37, 39, 41, 51, 109, 111, 113), convidant a anar més enllà de la superficialitat i a connectar amb els grans reptes globals.
*   **Arturo Sosa S.J. (Superior General 2016-actualitat):** Ha consolidat les **Preferències Apostòliques Universals (PAU)** 2019-2029 (DOC 29, 111, 113): "Mostrar el camí cap a Déu mitjançant els Exercicis Espirituals i el discerniment", "Caminar amb els pobres, els descartats del món, els vulnerats en la seva dignitat en una missió de reconciliació i justícia", "Acompanyar els joves en la creació d'un futur esperançador" i "Col·laborar en la cura de la Casa Comuna". Aquestes PAU guien la missió educativa actual (DOC 28, 30, 34, 35, 36, 43, 47, 49, 52, 53, 54, 87, 88, 89, 90, 91, 93, 94, 96).

**Evidència Clau i Tensions:**
L'evidència es troba en els documents fundacionals i els discursos dels Pares Generals, que mostren una evolució constant del carisma ignasià per adaptar-se als "signes dels temps" (DOC 92). La **Ratio Studiorum de 1599** (DOC 107, 111) va ser el primer intent d'organitzar un sistema educatiu jesuïta, centrat en "virtuts i lletres" (DOC 113). Amb el temps, i especialment a partir del Concili Vaticà II i la CG32 (DOC 66, 68), la Companyia va integrar més profundament la promoció de la justícia com a "exigència absoluta" de la fe (DOC 68, 94).
...
*71 documents citats de 113 al corpus · secció generada automàticament*
