...
*   **Heurístiques per al docent:**
    *   **Heurística: "El Pont Cultural"**
        ...
        *   **Exemple complet de raonament:** Davant la preocupació d'un docent perquè l'Amal, una alumna nouvinguda excel·lent en matemàtiques, té un rendiment molt baix en ciències socials, especialment en temes d'història de Catalunya: aquesta disparitat no indica una manca de capacitat, sinó probablement una llacuna de coneixements previs i de referents culturals específics de la història local. En lloc de simplement repetir continguts, convé buscar maneres de connectar la història catalana amb la història o els referents culturals del país d'origen de l'Amal. Per exemple, es pot proposar un projecte on l'Amal investigui esdeveniments paral·lels o figures històriques rellevants de la seva cultura durant un període similar, i després comparteixi les seves troballes amb la classe. Això no només valida el seu bagatge i li dóna un punt d'ancoratge per al nou aprenentatge, sinó que també enriqueix la perspectiva de tot el grup sobre la història global.
    *   **Heurística: "La Lupa Lingüística Acadèmica"**
        ...
        *   **Exemple complet de raonament:** Davant una alumna (la Isabel, 2n d'ESO, fa dos anys que va arribar) que ja parla català amb els companys, però li costa molt entendre els enunciats dels problemes de ciències o redactar resums de textos argumentatius: la Isabel probablement ha assolit un nivell de llengua comunicativa, però encara necessita suport per a la llengua acadèmica, que és més abstracta i específica de cada àrea. Convé activar estratègies com: proporcionar glossaris visuals o bilingües de termes clau abans de les unitats didàctiques, ensenyar explícitament estructures gramaticals i connectors textuals típics del llenguatge acadèmic, o utilitzar organitzadors gràfics per desglossar conceptes complexos. L'objectiu és fer visible la llengua acadèmica i oferir eines per al seu domini progressiu, assegurant que la Isabel pugui accedir al contingut sense que la barrera lingüística sigui un impediment.
    *   **Heurística: "El Mapa de Rutines"**
        ...
        *   **Exemple complet de raonament:** Davant un docent preocupat perquè un alumne nouvingut sovint no compleix amb les instruccions de treball en grup, o interromp les explicacions sense adonar-se'n, malgrat que ja li ha explicat les normes: l'alumne pot provenir d'un sistema educatiu amb dinàmiques d'aula molt diferents, on les normes implícites aquí són explícites o inexistents allà. No n'hi ha prou amb explicar les normes oralment, cal visualitzar-les amb un "mapa" o "guia" de rutines d'aula (pòsters amb imatges, llistes de passos per a activitats comunes). Convé assignar un "company mentor" que l'ajudi a navegar per aquestes rutines durant les primeres setmanes. L'objectiu és fer explícites les expectatives i els procediments, reduint la incertesa i facilitant la seva participació activa i autònoma en l'entorn escolar.
    *   **Heurística: "L'Àlbum d'Identitats"**
        ...
        *   **Exemple complet de raonament:** Davant una docent que vol que els seus alumnes de primària coneguin millor els seus companys nouvinguts i valorin la diversitat de l'aula: la millor manera de fomentar la inclusió és a través del coneixement i la valoració mútua de les històries personals i culturals. Una proposta útil és la creació d'un "Àlbum d'Identitats" a la classe. Cada alumne, inclosos els nouvinguts, pot crear una pàgina amb dibuixos, fotos o paraules sobre la seva família, les seves tradicions, els seus jocs preferits, la seva llengua materna o un lloc important del seu país d'origen. Els alumnes nouvinguts poden rebre suport per expressar-se en català o utilitzar la seva llengua materna. Aquest àlbum es pot compartir periòdicament, permetent que tots els alumnes coneguin i valorin la riquesa cultural de cadascú, transformant la diversitat en un recurs pedagògic i enfortint els llaços socials.
    *   **Heurística: "El Radar d'Expectatives Familiars"**
        ...
        *   **Exemple complet de raonament:** Davant un docent que s'adona que la família d'un alumne nouvingut no assisteix a les reunions escolars i sembla poc implicada: aquesta "desconnexió" pot no ser per desinterès, sinó per desconeixement del sistema educatiu, barreres lingüístiques, o diferents concepcions sobre el rol de la família en l'escola. Cal activar el protocol d'acollida familiar, assegurant-se que la comunicació es faci en la llengua familiar si és possible (amb intèrpret si cal) i que s'expliquin de manera clara i senzilla les expectatives del centre, el calendari escolar, els canals de comunicació i el paper de la família en l'educació dels fills. Convé proposar una reunió individualitzada i més informal amb la família, en un horari flexible, per escoltar les seves expectatives i preocupacions, i establir un canal de comunicació de confiança. L'objectiu és construir un pont de comunicació i col·laboració, assegurant que la família se senti part de la comunitat educativa i pugui donar suport a l'aprenentatge del seu fill.
...
*   **Heurístiques per a l'alumne:**
    *   **Heurística: "La meva veu és un tresor"**
        ...
        *   **Exemple complet de raonament:** Davant un alumne nouvingut que se sent aïllat a classe perquè li costa molt participar en els debats o fer preguntes en català, tot i tenir idees clares: la seva llengua materna no és un obstacle, sinó una eina i una part de la seva identitat que pot ser molt útil. Convé animar-lo a utilitzar la seva llengua materna per organitzar les seves idees abans d'intentar expressar-les en català, o a buscar el significat de paraules complexes en el seu idioma per ajudar a la comprensió. Si el docent ho permet, pot preguntar als seus companys bilingües o utilitzar un traductor per a moments puntuals. Cal reforçar la idea que la seva capacitat de pensar en dues llengües és una fortalesa, i que compartir aspectes de la seva cultura o llengua quan sigui pertinent pot enriquir la classe, transformant la frustració en una oportunitat per a ell i per als altres.
    *   **Heurística: "El meu mapa d'aprenentatge"**
        ...
        *   **Exemple complet de raonament:** Davant un alumne nouvingut que s'adona que no entén moltes referències històriques o geogràfiques que es donen per sabudes a classe, i que això el fa sentir endarrerit: és normal sentir-se així en un nou sistema educatiu i hi ha maneres de construir aquest "mapa" de coneixements. Convé animar-lo a parlar amb el seu docent per identificar les llacunes més importants i a demanar recursos addicionals (llibres, vídeos, mapes interactius) que li puguin ajudar a contextualitzar. Cal animar-lo també a buscar connexions entre els nous continguts i el que ja sap de la seva cultura d'origen, o a crear els seus propis mapes conceptuals o línies del temps per organitzar la informació. L'objectiu és empoderar l'alumne perquè prengui un rol actiu en la construcció del seu coneixement, utilitzant estratègies que l'ajudin a connectar el que ja sap amb el que ha d'aprendre.
