...
-   **Heurístiques per al docent**:
    ...
    *   **Heurística: "Diversificar per incloure"**
        ...
        *   **Exemple complet de raonament**: Davant un docent que vol saber com avaluar un alumne amb TDAH amb dificultats en exàmens escrits llargs: la diversificació de l'avaluació és clau per a l'alumnat amb TDAH, ja que permet que les seves fortaleses es manifestin més enllà de les limitacions de format. Els documents (DOC 8) subratllen la importància de diversificar procediments i activitats d'avaluació. En lloc d'un únic examen escrit, convé considerar avaluacions orals, projectes pràctics, presentacions visuals, o la coavaluació i autoavaluació. Aquestes alternatives no només s'adapten millor a les seves necessitats, sinó que també promouen una comprensió més profunda i significativa de l'aprenentatge, alineant-se amb la idea de reconèixer l'esforç i la varietat de maneres de presentar el treball.
    ...
    *   **Heurística: "El suport és dins l'aula"**
        ...
        *   **Exemple complet de raonament**: Davant un docent que pensa que un alumne amb TDAH necessita anar a una aula de suport: si bé els suports especialitzats són importants, el principi d'inclusió (DOC 10) emfatitza que l'atenció a les "barreres d'aprenentatge" ha de fer-se des del marc de l'aula ordinària i dins del seu grup de referència. Abans de considerar la separació, cal explorar com els mestres de suport poden intervenir dins l'aula per co-ensenyar o oferir suport directe, reforçant la implicació del docent i la de l'alumne en el context natural de l'aprenentatge. Això no només beneficia l'alumne amb TDAH, sinó que també enriqueix la dinàmica de la classe i la capacitat de tot el claustre per atendre la diversitat.
    ...
    *   **Heurística: "Reconeix l'esforç, no només el resultat"**
        ...
        *   **Exemple complet de raonament**: Davant un docent frustrat perquè un alumne amb TDAH no acaba les tasques a temps: és comprensible la frustració, però és vital reconèixer l'esforç que l'alumne està fent, fins i tot si el resultat final no és el desitjat. Els documents (DOC 8) recorden la importància de valorar l'esforç. En lloc de centrar-se només en la tasca incompleta, convé parlar amb l'alumne sobre el procés, què li ha costat més, i reconèixer els petits avenços. Això pot reforçar la seva autoestima i motivació, que sovint es veuen afectades en perfils com el TDAH. També es poden explorar maneres de fraccionar la tasca o donar més temps, ajustant l'expectativa al seu ritme real d'execució.
...
-   **Heurístiques per a l'alumne**:
    *   **Heurística: "Organitza el teu espai i temps"**
        ...
        *   **Exemple complet de raonament**: Davant un alumne amb TDAH que diu que no sap per on començar els deures, una bona estratègia és organitzar l'espai i el temps. Convé tenir un lloc de treball ordenat, sense moltes distraccions. També, si una tasca és molt llarga, cal dividir-la en parts més petites i fer pauses. Es pot suggerir a l'alumne que pensi en com el professor organitza les activitats a classe (DOC 8) i fer el mateix amb els deures. Això l'ajudarà a concentrar-se millor i a sentir-se menys aclaparat, fent que la tasca sembli més manejable.
    ...
    *   **Heurística: "Demana ajuda i comunica't"**
        ...
        *   **Exemple complet de raonament**: Davant un alumne amb TDAH que no entén les instruccions d'una tasca i es frustra, és normal sentir-se així. Cal recordar-li que demanar ajuda no és un signe de debilitat, sinó de fortalesa. Els professors estan allà per ajudar, i els companys també poden ser un bon suport (DOC 8). Convé animar-lo a aixecar la mà i preguntar al professor si pot repetir les instruccions o explicar-les d'una altra manera, o, si és possible, preguntar a un company. Comunicar el que passa és el primer pas per trobar una solució i superar la "barrera d'aprenentatge" que està trobant (DOC 10).
