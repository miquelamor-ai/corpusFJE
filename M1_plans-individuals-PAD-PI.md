...
Abans d'activar aquest protocol, el centre ha de tenir establerts els següents elements:
*   Un projecte educatiu de centre (PEC) que integri els principis d'escola inclusiva i atenció a la diversitat (DOC 10).
*   Una Comissió d'Atenció a la Diversitat (CAD) constituïda i amb funcions definides (DOC 8, DOC 9, DOC 10).
*   Coneixement i sensibilització del claustre sobre les múltiples dimensions de la diversitat de l'alumnat i les barreres d'aprenentatge (DOC 1, DOC 2, DOC 3, DOC 4, DOC 10).
*   Identificació dels recursos humans i materials disponibles al centre per a l'atenció a la diversitat (DOC 9, DOC 10).
*   Canals de comunicació fluids amb les famílies i els serveis externs (EAP, CDIAP, EAIA, etc.) (DOC 10).

## Fases

### Fase 1: Detecció i identificació de necessitats

*   **Accions:** Observació sistemàtica a l'aula, anàlisi social i cognitiu de grup (DOC 10), detecció de senyals d'alerta (DOC 8), recollida d'informació de l'alumnat (inclòs el traspàs d'informació de primària a secundària - DOC 9). Converses amb l'alumne i la família.
*   **Responsable:** Tutor/a, equip docent, CAD.
*   **Temporització:** Contínua al llarg del curs, especialment a l'inici i davant de l'aparició de dificultats.
*   **Eines:** Registres d'observació, anàlisis de grup (DOC 10), qüestionaris, entrevistes.
*   **Resultat esperat:** Identificació de barreres d'aprenentatge o necessitats de suport educatiu, aplicació de mesures ordinàries a l'aula.

### Fase 2: Avaluació psicopedagògica i diagnòstic (si s'escau)

*   **Accions:** Si les mesures ordinàries no són suficients, la CAD deriva l'alumne als serveis psicopedagògics (EAP) per a una avaluació més especialitzada (DOC 9, DOC 10). Realització de proves, entrevistes i observacions per part de l'EAP.
*   **Responsable:** CAD, EAP.
*   **Temporització:** Després de la detecció inicial i l'aplicació de mesures ordinàries sense èxit.
*   **Eines:** Protocols de derivació (DOC 9), proves estandarditzades, informes psicopedagògics.
*   **Resultat esperat:** Informe psicopedagògic que detalla les necessitats educatives de l'alumne i orienta sobre les mesures de suport.

### Fase 3: Elaboració del Pla d'Atenció a la Diversitat (PAD) del centre

*   **Accions:** La CAD, amb la participació del claustre, concreta les mesures d'atenció a la diversitat (ordinàries, extraordinàries, excepcionals) que s'implementaran al centre (DOC 8, DOC 9). Es defineixen els recursos humans i materials, els criteris de distribució i les coordinacions (DOC 9, DOC 10).
*   **Responsable:** CAD, equip directiu, claustre.
*   **Temporització:** Anualment, amb revisió i actualització.
*   **Eines:** Plantilla de PAD (DOC 9).
*   **Resultat esperat:** Document PAD aprovat pel claustre i el Consell Escolar, que serveix de marc per a l'atenció a la diversitat al centre.

### Fase 4: Elaboració de Plans Individualitzats (PI) o Adaptacions Curriculars Individualitzades (ACI)

*   **Accions:** Per a l'alumnat amb Necessitats Específiques de Suport Educatiu (NESE) que requereixen mesures extraordinàries, es dissenya un PI/ACI. Aquest document inclou les dades de l'alumne, el motiu del pla, i les mesures pedagògiques i socials a prendre (ordinàries, extraordinàries, excepcionals, altres) (DOC 6). Es defineixen objectius, continguts, metodologia i criteris d'avaluació adaptats. Es consensua amb la família i, si és possible, amb l'alumne.
*   **Responsable:** Tutor/a, equip docent implicat, especialistes de suport (USEE, LIC-AA - DOC 5, DOC 10), EAP.
*   **Temporització:** Un cop identificades les NESE i el PAD no és suficient, o en el cas d'alumnat amb altes capacitats (DOC 6).
*   **Eines:** Plantilla de PI/ACI (DOC 6, DOC 9).
*   **Resultat esperat:** PI/ACI consensuat, signat per totes les parts implicades i implementat.

### Fase 5: Implementació i coordinació del suport

*   **Accions:** Aplicació de les mesures i adaptacions definides al PAD i als PIs/ACIs. Coordinacions setmanals, mensuals o trimestrals entre tutors, especialistes, EAP i serveis externs (CAD, EE-USEE, reunions d'infantil i primària, coordinacions amb CEE, EAIA, CDIAP, fisioterapeuta, logopeda, EAP deficients visuals - DOC 10). Seguiment específic de l'alumnat nouvingut a les Aules d'Acollida (DOC 5).
*   **Responsable:** Tot el claustre, tutors, especialistes de suport, CAD.
*   **Temporització:** Contínua durant tot el curs escolar.
*   **Eines:** Agendes de coordinació, registres de seguiment, programacions d'aula.
*   **Resultat esperat:** Suport educatiu efectiu i coordinat, que afavoreix la participació i l'aprenentatge de tot l'alumnat.

### Fase 6: Seguiment i avaluació

*   **Accions:** Avaluació periòdica de l'eficàcia de les mesures del PAD i dels PIs/ACIs (DOC 6, DOC 9). Revisió dels objectius i ajust d'estratègies si cal. Avaluació del funcionament de les Aules d'Acollida (DOC 5). Recollida de feedback de l'alumnat, famílies i professionals.
*   **Responsable:** Tutor/a, CAD, EAP, equip directiu.
*   **Temporització:** Trimestral per als PIs/ACIs, anual per al PAD i el funcionament general de l'atenció a la diversitat.
*   **Eines:** Informes d'avaluació, reunions de seguiment, enquestes de satisfacció.
*   **Resultat esperat:** Ajustament continu de les estratègies i mesures per optimitzar l'atenció a la diversitat i garantir la millora de l'aprenentatge i el benestar de l'alumnat.
